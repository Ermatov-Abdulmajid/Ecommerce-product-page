...
const sideBar = elHeader.querySelector(".site-header__sitenav");
const open = elHeader.querySelector(".site-header__manu-button");
const close = elHeader.querySelector(".site-header__close-button");
